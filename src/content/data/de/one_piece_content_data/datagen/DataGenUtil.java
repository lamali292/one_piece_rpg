...
public class DataGenUtil {
    ...
    public static String generateDeterministicId(String skillId) {
        try {
            // SHA-256 Hash der skill ID
            java.security.MessageDigest digest = java.security.MessageDigest.getInstance("SHA-256");
            byte[] hash = digest.digest(skillId.getBytes(java.nio.charset.StandardCharsets.UTF_8));
            ...
            return generateSimpleHash(skillId);
        }
    }
