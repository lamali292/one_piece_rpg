...
import de.one_piece_api.screen.manager.SpellManager;
import de.one_piece_api.screen.manager.SpellSlotManager;
...
import de.one_piece_api.screen.widget.*;
...
public class OnePieceScreen extends GenericTabbedScreen {
    ...
    private record ScreenPosition(int x, int y) {
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof ScreenPosition(int x1, int y1))) return false;
            return x == x1 && y == y1;
        }
